...
python calib.py --path propensity/ensemble/coat.pt --dir ensemble --dataset coat
python calib.py --path propensity/ensemble/yahoo.pt --dir ensemble --dataset yahoo
...
python calib.py --path propensity/ls+ensemble/coat.pt --dir ls+ensemble --dataset coat
python calib.py --path propensity/ls+ensemble/yahoo.pt --dir ls+ensemble --dataset yahoo
