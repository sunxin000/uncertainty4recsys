...
class NeuMF(nn.Module):
    def __init__(
        self, num_users, num_items, mf_emb_size, mlp_emb_size, mlp_hidden_size, dropout=0., output_logits=False,
        ) -> None:
        super().__init__()
    ...
    def forward(self, user, item):
        ...
        logits = self.predict_layer(torch.cat((mf_output, mlp_output), -1))
